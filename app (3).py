...
{{
  ...
  "key_evidence": ["evidence stat 1", "evidence stat 2", "AI insight sentence"],
...
<div style="font-family:'DM Sans',sans-serif">
  ...
  <div style="background:#f8fafc;border:1px solid #e2e8f0;padding:16px 20px;border-top:none">
    <div style="font-size:11px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:1px;margin-bottom:10px">3. Strategic Insights (AI-Generated)</div>
...
<div style="font-family:'DM Sans',sans-serif">
  ...
  <div style="background:#f8fafc;border:1px solid #e2e8f0;padding:16px 20px;border-top:none">
    ...
    <ul style="margin:0;padding-left:18px;font-size:13px;line-height:1.8;font-style:italic">{evidence}</ul>
  </div>
  ...
  <div style="background:white;border:1px solid #e2e8f0;padding:16px 20px;border-top:none">
    <div style="font-size:11px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:1px;margin-bottom:10px">6. Value Delivered</div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:12px">
        <div style="font-size:11px;color:#64748b;margin-bottom:4px">Cost per participant</div>
        <div style="font-size:18px;font-weight:700;color:#1c2b4a">{d.get('cost_per_participant','~$12')}</div>
      </div>
      <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:12px">
        <div style="font-size:11px;color:#64748b;margin-bottom:4px">Efficiency gain from AI reporting</div>
        <div style="font-size:18px;font-weight:700;color:#1c2b4a">{d.get('efficiency_gain','85% time saved')}</div>
      </div>
    </div>
  </div>

  <div style="background:#f0fdf4;border:1px solid #bbf7d0;padding:16px 20px;border-top:none;border-radius:0 0 10px 10px">
    <div style="font-size:11px;font-weight:700;color:#065f46;text-transform:uppercase;letter-spacing:1px;margin-bottom:10px">7. Future Opportunities</div>
    {future}
  </div>
</div>"""
...
def _demo_reports():
    ...
    funding_data = {
        ...
        "key_evidence": [
            ...
            "AI analysis identified strongest impact in underserved regional and low-SES communities, where Joy & Wonder scores exceeded metro averages by 12%."
        ],
        ...
        "efficiency_gain": "85% reduction in manual reporting time through AI-automated analysis",
